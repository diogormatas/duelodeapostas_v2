...
for($i=0;$i<20;$i++){
    ...
    $username="qa_load_".rand(10000,99999);
...
test("users created",count($users)==20);
...
test("bets created",count($bets)==20);
...
$expectedPool=$entry*20;

test("pool correct",$row['total']>=$expectedPool);

/*
-------------------------------------
CHECK WALLET NEVER NEGATIVE
-------------------------------------
*/
